...
This is a sample template for helloworld-python - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name helloworld-python --query 'Stacks[].Outputs'
```
