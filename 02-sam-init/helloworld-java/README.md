...
This is a sample template for helloworld-java - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name helloworld-java --query 'Stacks[].Outputs'
```
