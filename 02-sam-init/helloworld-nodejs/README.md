...
This is a sample template for helloworld-nodejs - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name helloworld-nodejs --query 'Stacks[].Outputs'
```
