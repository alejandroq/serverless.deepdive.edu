...
This is a sample template for todo-list-api - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name todo-list-api --query 'Stacks[].Outputs'
```
